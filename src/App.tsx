  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <p className="text-justify p-16 font-normal text-lg">Bem-vindo à <h1 className="text-8xl text-center">AgroBounty Analytics</h1>, especializada em análise de dados florestais. Nós oferecemos soluções avançadas de análise de dados para proprietários de florestas, empresas de manejo florestal, agências governamentais e outros interessados no setor florestal.
...
Não importa o tamanho da sua propriedade ou a complexidade das suas necessidades, a [nome da empresa] está pronta para ajudá-lo a atingir seus objetivos de manejo florestal. Entre em contato conosco hoje mesmo para saber mais sobre nossos serviços de análise de dados florestais.</p>
      </div>
      <div className="flex justify-center items-center flex-col">
        <h1 className="text-6xl mb-4">Tecnologias</h1>
        <div className="flex justify-around w-full items-center mb-3">
            <img className="flex max-w-48 max-h-48 rounded-3xl" src="./public/pbix.png" alt="PBIX"/>
            <img className="flex max-w-48 max-h-48" src="./public/python.png" alt="PBIX"/>
        </div>
      </div>
